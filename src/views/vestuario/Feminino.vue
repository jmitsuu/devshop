...
async function getWomanClothing() {
...
const textHeader = "As melhores tendencias para elas! \nDescubra nossa incrível variedade de estilos para moda feminina, com a mais alta qualidade. Venha conferir nossa coleção completa!";
...
<template>
  <section class="min-h-screen">
    <header>
      <HeaderGen :title="'Feminino'" :text="textHeader" />
    </header>
