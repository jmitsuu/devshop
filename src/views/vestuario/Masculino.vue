...
const textHeader = "As melhores tendencias para eles! \nDescubra nossa incrível variedade de estilos para moda masculina, com a mais alta qualidade. Venha conferir nossa coleção completa!";
...
<template>
  <section class="min-h-screen">
    <header>
      <HeaderGen :title="'Masculino'" :text="textHeader" />
    </header>
